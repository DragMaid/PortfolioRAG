...
const PATHS: Record<IconName, string> = {
  ...
  key: "M14.5 9.5a3.5 3.5 0 1 1 3.5 3.5 3.6 3.6 0 0 1-1.4-.3L14.8 14.4l-1.9.3.3-1.9 4.4-4.4M3 21l6.5-6.5",
  link: "M10.5 13.5a3.5 3.5 0 0 0 5 0l3-3a3.54 3.54 0 0 0-5-5l-1 1M13.5 10.5a3.5 3.5 0 0 0-5 0l-3 3a3.54 3.54 0 0 0 5 5l1-1",
  logout: "M15 4h3a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1h-3M10 17l5-5-5-5M15 12H4",
  ...
  sparkle: "M12 3.5 13.6 8.4 18.5 10 13.6 11.6 12 16.5 10.4 11.6 5.5 10 10.4 8.4 12 3.5ZM18 16l.7 2.1 2.1.7-2.1.7L18 21.6l-.7-2.1-2.1-.7 2.1-.7L18 16Z",
